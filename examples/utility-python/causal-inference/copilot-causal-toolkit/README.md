...
**DEMOGRAPHIC_VARS** - Organizational attributes for subgroup analysis:
```python
DEMOGRAPHIC_VARS = [
    ...
    'Area',              # e.g., 'Region', 'Geography', 'Location'
    'CountryOrRegion',   # Add or remove based on your data
]
```
...
NETWORK_VARS = [
    ...
    # Add any custom network metrics your organization tracks
]
```
...
COLLABORATION_VARS = [
    ...
    'Collaboration_hours',
    'Total_focus_hours',
    # Add metrics like 'Collaboration_span' if available
]
```

**SUBGROUP_VARIABLES** - Which attributes to use for finding heterogeneous effects:
```python
SUBGROUP_VARIABLES = [
    'Organization',
    'FunctionType',
    'IsManager',
    # Include 2-4 key attributes you want to analyze
]
```
...
- [ ] All variables in `DEMOGRAPHIC_VARS` exist in your dataset
...
- **Solution:**
  ...
  2. Update `DEMOGRAPHIC_VARS`, `NETWORK_VARS`, etc. to match your actual column names
