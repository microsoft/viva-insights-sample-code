...
In this example, we will use the sample `g2g_data` dataset from the **vivainsights** package. We will also use **dplyr** and **purrr** for data manipulation and iteration respectively, and you can load the **igraph** package for network graph creation and visualization
