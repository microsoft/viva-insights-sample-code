...
Exclude unlicensed users from denominators, then define weekly usage segments from percentiles in the actual data rather than fixed cutoffs, and print the thresholds you used.
