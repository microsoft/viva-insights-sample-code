...
<nav class="ci-series-nav" aria-label="Causal inference guide">
  ...
  <a class="ci-chip is-current" href="{{ site.baseurl }}/causal-inference-regression/"><span class="ci-chip-step">4</span>Regression</a>
...
<nav class="ci-pager" aria-label="Causal inference pagination">
  <a class="ci-pager-link" href="{{ site.baseurl }}/causal-inference-data-prep/">
    <span class="ci-pager-dir">← Back</span>
    <span class="ci-pager-title">Data prep</span>
  </a>
  <a class="ci-pager-link is-next" href="{{ site.baseurl }}/causal-inference-propensity/">
    <span class="ci-pager-dir">Next →</span>
    <span class="ci-pager-title">Propensity</span>
  </a>
</nav>
